...
my $today_dir  = "/var/www/osm.nix.is/root/diff/archive/$today";
my $latest_dir = "/var/www/osm.nix.is/root/diff/latest";
...
my $file = "/var/www/osm.nix.is/root/archive/$year-$month-$day/Iceland.osm.bz2";
...
$file = "/var/www/osm.nix.is/root/archive/$year-$month-$day/Iceland.osm.bz2";
